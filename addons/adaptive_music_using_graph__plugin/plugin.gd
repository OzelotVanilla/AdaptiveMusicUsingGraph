...
const music_graph_main_panel_scene := preload("res://addons/adaptive_music_using_graph__plugin/editor/main_panel/MusicGraphMainPanel.tscn")
var music_graph_main_panel: MusicGraphMainPanel = self.music_graph_main_panel_scene.instantiate()
const music_graph_bottom_panel_scene := preload("res://addons/adaptive_music_using_graph__plugin/editor/bottom_panel/MusicGraphBottomPanel.tscn")
